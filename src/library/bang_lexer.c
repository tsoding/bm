...
static_assert(COUNT_BANG_TOKEN_KINDS == 14, "The amount of token kinds have changed. Make sure you don't need to add anything new to the list of the hardcoded tokens");
...
static_assert(COUNT_BANG_TOKEN_KINDS == 14, "The amount of token kinds have changed. Please update the table of token kind names. Thanks!");
